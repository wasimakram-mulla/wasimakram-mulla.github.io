var boxType = {
    ...
    drawSimpleSkybox: function() {
        ...
        var path = 'images/';
        var sides = [ path + 'image6.jpg', path + 'image5.jpg', path + 'image4.jpg', path + 'image3.jpg', path + 'image2.jpg', path + 'image1.jpg'];
        ...
        var skyMaterial = new THREE.ShaderMaterial( {
          ...
          uniforms: skyShader.uniforms, depthWrite: false, side: THREE.FrontSide
        });

        // create Mesh with cube geometry and add to the scene
        var skyBox = new THREE.Mesh(new THREE.CubeGeometry(50, 50, 50), skyMaterial);
